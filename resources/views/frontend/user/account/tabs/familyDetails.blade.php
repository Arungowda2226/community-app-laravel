        ...
        <div>
            ...
            <table id="family_table{{$index}}" class="table table-striped table-hover table-bordered mb-0">
                ...
                <tr>
                    <th>@lang('Photo')</th>
                    <td>
                        <input type="file" class="form-control" id="photo" name="inputs[{{ $index }}][photo]" onchange="displayPhoto(this, {{ $index }})" placeholder="Enter Photo">
                        <img id="photoPreview{{ $index }}" src="#" alt="Photo Preview" style="max-width: 200px; max-height: 200px; margin-top: 10px; display: none;">
                    </td>
                </tr>
                <tr>
                    <th>@lang('DOB')</th>
                ...
                <tr>
                    <th>
                        <input type="hidden" name="inputs[{{$index}}][form_id]" value="{{$family->id}}">
    ...
    <script>
         $(document).ready(function() {
            ...
            $('#addMoreFamily').click(function() {
                ...
                var newForm = `
                   <table class="table table-striped table-hover table-bordered mb-0">
                    ...
                    <tr>
                        <th>@lang('Origin City')</th>
                        <td><input type="text" class="form-control" id="originCity" name="inputs[${formCount}][origin_city]" placeholder="Enter OriginCity"></td>
                    </tr>
                    <tr>
                        <th>@lang('Blood Group')</th>
                        <td><input type="text" class="form-control" id="bloodGroup" name="inputs[${formCount}][blood_group]" placeholder="Enter BloodGroup"></td>
                    </tr>
                    <tr>
                        <th>
            ...
            $(document).on('click', '.removeForm', function() {
                ...
                var formId = $(this).closest('table').find('input[name="inputs[' + index + '][form_id]"]').val();
                $.ajax({
